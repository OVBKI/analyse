...
## Rapport macroéconomique quotidien (Or, Nasdaq 100, S&P 500, DAX 40)

Ce dépôt reçoit chaque jour un rapport macro dans `docs/analyses/AAAA-MM-JJ-analyse-macro-or-nasdaq-sp500-dax.md`
(voir les fichiers existants pour la structure et le niveau de détail attendus).
